        ...
        fn set_cell(grid: &mut Grid, cell: usize, index: usize) -> Option<()> {
            if cell < 72 {
                let cell_type = match (cell / 2) % 9 {
                    0 => crate::quell::cell_data::GENERATOR,
                    1 => crate::quell::cell_data::ROTATOR_CW,
                    2 => crate::quell::cell_data::ROTATOR_CCW,
                    3 => crate::quell::cell_data::MOVER,
                    4 => crate::quell::cell_data::SLIDE,
                    5 => crate::quell::cell_data::PUSH,
                    6 => crate::quell::cell_data::WALL,
                    7 => crate::quell::cell_data::ENEMY,
                    8 => crate::quell::cell_data::TRASH,
